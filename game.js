...
function arm(parent,side,mat,tool){
 const shoulder=new THREE.Group();shoulder.position.set(side*1.12,3.48,0);shoulder.rotation.y=Math.PI;parent.add(shoulder);box(shoulder,[.64,1.12,.68],[0,-.48,0],mat);
